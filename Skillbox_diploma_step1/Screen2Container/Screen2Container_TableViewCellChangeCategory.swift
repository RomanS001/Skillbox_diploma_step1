...
class Screen2Container_TableViewCellChangeCategory: UITableViewCell, UITextFieldDelegate {
    ...
    @IBAction func buttonDeleteCategoryAction(_ sender: Any) {
        delegateScreen2Container?.returnDelegateScreen2().returnDelegateScreen1().deleteCategoryInCoreData(id: specCellTag)
...
//        addGestureRecognizer(gestureCheckBox!)
        ...
        delegateScreen2Container?.returnDelegateScreen2().returnDelegateScreen1().editCategoryInCoreData(newName: textFieldNameCategory.text!, newIcon: "", id: specCellTag)
